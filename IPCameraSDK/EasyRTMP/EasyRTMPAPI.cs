...
namespace IPCameraSDK.EasyRTMP
{
    /// <summary>
    /// RTMP推流客户端
    /// </summary>
    public class EasyRTMPAPI
    {
        ...
        private extern static bool EasyRTMP_Connect_Win32(IntPtr handle, System.Text.StringBuilder url);
        ...
        private extern static bool EasyRTMP_Connect_Linux(IntPtr handle, System.Text.StringBuilder url);
        ...
        /// 是否初始化媒体信息
        /// </summary>
        public bool IsInitMetadata { get; set; }
        ...
        /// <returns></returns>
        public KeyValuePair<bool, string> Connect(System.Text.StringBuilder url)
        {
            if(!this.IsInit)
            {
                return new KeyValuePair<bool, string>(false, "RTMP 未创建!");
