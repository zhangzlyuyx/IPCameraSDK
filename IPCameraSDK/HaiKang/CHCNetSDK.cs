...
namespace IPCameraSDK.HaiKang
{
    ...
    {
        const string LIB_HCNetSDK = @"HCNetSDK.dll";
        ...
        **********************************************************/
        ...
        /// <returns></returns>
        [DllImport(LIB_HCNetSDK)]
        public static extern bool NET_DVR_SetESRealPlayCallBack(int lRealHandle, FPlayESCallBack cbPlayESCallBack, IntPtr pUser);
        ...
        ******************************************************************************/
        ...
        [DllImportAttribute(LIB_HCNetSDK)]
